...
**Оперативные задачи ведутся в GitHub Issues** (#21–#45, правило CLAUDE.md §9) —
этот файл остаётся картой приоритетов аудита.
...
- [ ] **F1.** Инструмент **Openings** (двери/окна/**гаражные ворота**): слот 4 радиала, панелизация готова → [03-openings.md](03-openings.md)
